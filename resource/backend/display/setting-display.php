...
if (!class_exists('PopupAllyDisplaySettings')) {
	class PopupAllyDisplaySettings {
		...
		public static function show_display_settings() {
			...
			$code .= '<div class="popupally-setting-section"><div class="popupally-setting-section-header">Want more popups? <a class="popupally-trial-link" href="https://popupally.com/upgrading-to-popupally-pro/" target="_blank">Get PopupAlly Pro now!</a></div></div></div>';
			echo esc_html($code);
		}
		...
		public static function load_display_template_arguments() {
			...
			$result = array();
			$result['disable'] = PopupAllySettingShared::load_file_template(dirname(__FILE__) . '/../../frontend/disable.php');
			...
			$result['display_detail_template'] = PopupAllySettingShared::load_file_template(dirname(__FILE__) . '/setting-display-popup-template.php');
		...
		private static function generate_page_post_selection_template($advanced, $page_template) {
			...
			$page_selection_template = PopupAllySettingShared::load_file_template(dirname(__FILE__) . '/setting-display-page-selection-template.php');
			...
			$post_selection_template = PopupAllySettingShared::load_file_template(dirname(__FILE__) . '/setting-display-post-selection-template.php');
