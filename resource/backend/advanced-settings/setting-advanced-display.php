...
<input type="hidden" name="no-inline" value="<?php echo esc_attr($advanced['no-inline']); ?>"/>
<div class="popupally-setting-section">
	...
	<div class="popupally-setting-configure-block">
		Load <input id="max-page" type="text" name="max-page" value="<?php echo esc_attr($advanced['max-page']); ?>"/> Pages
	</div>
</div>
<div class="popupally-setting-section">
	...
	<div class="popupally-setting-configure-block">
		Load <input id="max-post" type="text" name="max-post" value="<?php echo esc_attr($advanced['max-post']); ?>"/> Posts
	</div>
</div>
<div class="popupally-setting-section">
